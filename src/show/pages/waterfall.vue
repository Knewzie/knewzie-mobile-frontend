...
export default {
  ...
  data() {
    return {
      waterfallList: [],
      imgArr: [
        require("../../images/activity_time.png"),
        require("../../images/activity_video.png"),
        require("../../images/bg.png"),
        require("../../images/btn_share.png"),
        require("../../images/bx-comment.png"),
        require("../../images/bx-eye-show.png"),
        require("../../images/bx-heart.png"),
        require("../../images/bx-heart2.png"),
        require("../../images/bx-map.png"),
      ],
