<template>
  <div class="Waterfall-box">
    <div v-show="list.length > 0" class="" id="">
      <Row :gutter="20">
        <Col
          :xs="12" 
          class=""
        ...
        >
          ...
          <div class="avatar-box">
            <Avatar
              height="20px"
              width="20px"
              :avatar="img.creator.avatar"
              
            />
            <div class="info">
              <span class="certificate-info">{{ img.creator.nickname }}</span>
            </div>
          </div>
          <div class="header4">
    ...
    <div v-show="list.length < 0">加载中...</div>
